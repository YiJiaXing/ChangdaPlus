...
public class Util {
	...
	public com.alibaba.fastjson.JSONObject getWeather(String cityid) {
		...
		json1.put("city", json.get("city"));
		json1.put("data", a.get(0));
		return json1;
	}

	private static JSONObject loadJson(String url) {
		...
		return new JSONObject().fromObject(json.toString());
	}

	/*
	 * 加密 1.构造密钥生成器KeyGenerator 2.根据ecnodeRules规则初始化密钥生成器 3.产生密钥 4.创建和初始化密码器 5.内容加密
	 * 6.返回字符串
	 */
